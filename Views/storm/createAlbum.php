...
<section class="container-type-1">
    ...
    <form action="createStormAlbum" method="post">
    <?php foreach ($listImgs as $img => $value): ?>
        <div class="card-photo">
            <img src=<?='/style/images/download/storm/albums/tmp/'.$value?> alt="">
            <div class="details-photo">
                ...
                <input type="hidden" name="photo[<?=$img?>]['data']" value="<?='/style/images/download/storm/albums/tmp/'.$value?>">
            </div>
        </div>
        <?php
        $index++;
