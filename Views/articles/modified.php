...
?>
<h2 class="title-type-1">MODIFIER UN ARTICLE</h2>
    ...
    <form method="post" action="<?=$link?>" enctype="multipart/form-data">
        ...
        <div id="check-bloc">
            ...
            <?php foreach ($tags as $tag) : ?>
                <div>
                    <input type="checkbox" id="<?= $tag->name_tag ?>" name="tags[]" value="<?= $tag->id_tag ?>" <?= in_array($tag->id_tag,$listTags) ? 'checked':'' ?> ">
        ...
        <div id="bloc-btn">
            <a href="#" title="Sauvegarder l'article" class="button-type-2"><img src="/style/images/pictos/buttons/floppy-disk-solid.svg" alt="">SAUVEGARDER</a>
